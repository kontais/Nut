...
COMMON_CFLAGS= -Iarch/x86/ -Iinclude/ -DX86 -I./ -Ilib/ -fno-asynchronous-unwind-tables -I./arch/x86/video/ -fno-builtin -Ifs/
...
OBJS=  boot/main.o  arch/x86/video/vga.o lib/assert.o lib/printf.o  lib/string.o  arch/x86/asm/start.o arch/x86/paging.o lib/bug.o arch/x86/int_ctl.o arch/x86/isa.o arch/x86/asm/interrupt_handler.o mm/vm.o arch/x86/asm/exception_handler.o arch/x86/pci.o fs/fat.o lib/coding.o
.PHONY:all
all:init kernel
